        ...
        <div className="bg-bgImage bg-cover">
            <div className="bg-gradient-to-b from-[#000000]/95 via-[#000000]/30 to-[#000000]/95">
                <nav className="flex flex-wrap flex-row justify-between">
                    ...
                    <button className="bg-[#e50914] rounded-md text-white px-3 sm:h-10 my-6 mx-16 xs:mx-5 sm:mx-16">Sign In</button>
                </nav>
                <div className="grid justify-items-center content-center">
                    ...
                    <div className="flex flex-row flex-wrap justify-center items-center w-screen mb-36">
                            <input type="text" className="from-input py-4 w-2/5 xs:w-full sm:w-2/5 xs:mx-5 sm:mx-0" placeholder="Email Address"/>
                            <button type="submit" className="bg-[#e50914] text-white px-4 xs:py-2 sm:py-4 xs:my-5 sm:my-0 xs:mx-auto sm:mx-0">Get Started ></button>
                        </div>
                </div>
            </div>
        </div>
