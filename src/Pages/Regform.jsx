...
const Regform = () => {
    ...
    function onSubmit(e) {
        e.preventDefault();
        if (signUpEmail === '') {
            dispatch(userActions.setTempEmail(''));
            dispatch(userActions.setEmail(tempEmail));
            dispatch(userActions.setPassword(signUpPassword));
            navigate("/signin")
        } else {
            dispatch(userActions.setTempEmail(''));
            dispatch(userActions.setEmail(signUpEmail));
            dispatch(userActions.setPassword(signUpPassword));
            navigate("/signin")
        }
    }
